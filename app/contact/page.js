        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-10">
              <div>
                <h4 className="text-indigo-600 font-bold text-lg mb-4">
                ...
                <p className="text-gray-600 leading-relaxed text-base md:text-lg">
                  ...
                  , we're dedicated to pioneering cutting-edge digital
                  solutions. Our team is passionate about crafting tailored
                  expertise that turns your vision into reality. With a strong
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-5 group">
                  ...
                  <span className="text-gray-700 font-medium">2246065742</span>
                </div>
                ...
                <div className="flex items-start gap-5 group">
                  ...
                  <span className="text-gray-700 font-medium leading-relaxed">
                    05, Aditya Industrial Estate, Mindspace, <br />
              ...
              <form className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <input
                    type="text"
                    placeholder="Name"
                    className="w-full px-6 py-4 bg-[#E0F4FF] border-none rounded-full focus:ring-2 focus:ring-orange-200 outline-none placeholder:text-gray-500 text-gray-800"
                  />
                  <input
                    type="text"
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-14 py-4 bg-[#E0F4FF] border-none rounded-full focus:ring-2 focus:ring-orange-200 outline-none placeholder:text-gray-500 text-gray-800"
                  />
                  <div className="absolute left-6 top-1/2 -translate-y-1/2 flex items-center gap-1 border-r border-gray-300 pr-2">
                ...
                <textarea
                  placeholder="Message"
                  rows={4}
                  className="w-full px-6 py-4 bg-[#E0F4FF] border-none rounded-[1.5rem] focus:ring-2 focus:ring-orange-200 outline-none placeholder:text-gray-500 text-gray-800 resize-none"
                />

                <button
                  type="submit"
                  className="w-fit text-white bg-gradient-to-r from-orange-500 to-pink-500 rounded-full px-12 py-4 text-sm font-bold shadow-lg hover:opacity-90 active:scale-95 transition-all uppercase tracking-widest"
                >
                  Send Message
                </button>
              </form>
